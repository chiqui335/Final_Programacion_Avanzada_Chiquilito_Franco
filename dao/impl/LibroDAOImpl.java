    ...
    public Libro leer(int id){
        try (Connection connection = ConexionDB.getInstance().getConnection();){
            ...
            if(rs.next()) {
                ...
                return new Libro (id, titulo, autor, tipo, tapaDura, activo, cantidadDisponible, cantidadTotal);
...
libros.add(new Libro(id, tituloLibro, autor, tipo, tapaDura, activo, cantidadDisponible, cantidadTotal));            }
            return libros;
