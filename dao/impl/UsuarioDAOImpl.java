    ...
    public Usuario leer(int id){
        try (Connection connection = ConexionDB.getInstance().getConnection();){
            ...
            if(rs.next()) {
                ...
                if (rol.equals("ADMIN")){
                    return new Admin ( id,  nombre,  username,  password,  dni,  email,  prestamosActuales,  totalPrestamos,  estaRetrasado,  activo); 
                } else {
                    return new UsuarioRegular ( id,  nombre,  username,  password,  dni,  email,  prestamosActuales,  totalPrestamos,  estaRetrasado,  activo); 
                }
            }
